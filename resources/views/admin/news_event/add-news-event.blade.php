        ...
        <!-- Custom tabs (Charts with tabs)-->
            <div class="card">
              <div class="card-header">
                <h3>
                 Add News and Events
  <a class="btn btn-success float-right btn-sm" href="{{route('news_events.view')}}"> <i class="fa fa-user"> News and Events List</i> </a>
              ...
              <div class="card-body">
               ...
               <form method="Post" action="{{route('news_events.store')}}" id="addUserForm" enctype="multipart/form-data">
                  @csrf
