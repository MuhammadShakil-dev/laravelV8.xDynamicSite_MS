		...
		<div class="container">
			<div class="row">
				<div class="col-md-8">
					...
					<p style="color: white">Address: {{$contact->address}}, Mobile: {{$contact->contact_no}}, Email: {{$contact->email}}</p>
				</div>
				<div class="col-md-4">
			...
			Copyright &copy; <script type="text/javascript">document.write(new Date().getFullYear())</script> @ 4Dimondtech
					</p>
				</div>
			</div>
		</div>
