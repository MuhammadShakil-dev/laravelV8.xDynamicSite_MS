		...
		<div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
		 ...
		 <!-- <li data-target="#carouselExampleIndicators" data-slide-to="0" class="active"></li>
		    ...
		    <div class="carousel-inner" role="listbox">
		      ...
		      <!-- <div class="carousel-item active" style="background-image: url('public/frontend/assets/image/slider4.jpeg')"> -->
		      ...
		      <!-- <div class="carousel-item" style="background-image: url('public/frontend/assets/image/slider5.jpg')">
		        <div class="carousel-caption d-none d-md-block">
		      ...
		      <!-- <div class="carousel-item" style="background-image: url('public/frontend/assets/image/slider6.jpg')">
		        <div class="carousel-caption d-none d-md-block">
