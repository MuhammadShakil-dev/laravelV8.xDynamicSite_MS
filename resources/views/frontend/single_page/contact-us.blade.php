	...
	<section class="banner_part">
		<img src="{{asset('public/frontend/assets/image/banner.jpg')}}" style="width: 100%">
	</section>
				...
				<div class="col-md-7">
					...
					<form method="Post" action="{{route('contact.store')}}">
						...
						<div class="form-row" style="background: #ddd;">
							...
							<div class="form-group col-md-6">
								<label for="contact_no">Contact No <span style="color: red;font-weight: bold;">*</span></label>
								<input type="text" name="contact_no" id="contact_no" class="form-control" placeholder="Write Your Mobile No" required>
							</div>
							<div class="form-group col-md-6">
