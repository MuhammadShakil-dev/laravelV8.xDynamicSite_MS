					...
					<table class="table table-striped table-bordered table-hover table-md table-warning">
						...
						<tbody>
							...
							<tr>
								...
								<td><img src="{{asset('public/upload/newsEvent_images/'.$news->image)}}" style="width: 200px; height: 120px"></td>
								<td> {{$news->short_title}}</td>
								<td><a href="{{route('news_events_details',$news->id)}}" class="btn btn-info">Details</a></td>
							</tr>
							@endforeach
						</tbody>
					</table>
